    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FREE', 'Free'), ('TRANSFER', 'Transfer'), ('ARRIVED', 'Arrived')], default='FREE', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ship_seat', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='ship_reservation', to='ship.shipseat')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True)),
                ('modified_time', models.DateTimeField(auto_now=True)),
                ('ship', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rate', to='ship.ship')),
        ...
        migrations.AddField(
            model_name='ship',
            name='destination',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='destination', to='ship.shipaddress'),
        ),
        migrations.AddField(
            model_name='ship',
            name='source',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='source', to='ship.shipaddress'),
        ),
        migrations.AddField(
            model_name='ship',
            name='type',
