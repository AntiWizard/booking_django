    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True)),
                ('modified_time', models.DateTimeField(auto_now=True)),
                ('Bus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rate', to='bus.bus')),
        ...
        migrations.AddConstraint(
            model_name='bus',
            constraint=models.UniqueConstraint(condition=models.Q(('transport_status__in', ['FREE', 'SPACE', 'TRANSFER'])), fields=('driver', 'transport_status'), name='unique_driver_transport_status'),
        ),
    ]
