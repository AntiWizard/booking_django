...
if not DEBUG:
    MINIO_ENDPOINT = config('MINIO_ENDPOINT', default='booking-minuei-storage.darkube.app')
    MINIO_ACCESS_KEY = config('MINIO_ACCESS_KEY', default='ZRZzBhzlI5rMXdAn854GGgqOU4Xzt3en')
    MINIO_SECRET_KEY = config('MINIO_SECRET_KEY', default='Hm5EOM5bxfdXVa96JHK46J3GP8TjJJ4E')
