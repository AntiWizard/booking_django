# Generated by Django 4.1.4 on 2022-12-10 22:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nationality', models.CharField(choices=[('IR', 'Iran'), ('UK', 'United Kingdom')], default='IR', max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('country', models.CharField(choices=[('IRAN', 'Iran')], max_length=50)),
                ('zip_code', models.BigIntegerField(unique=True, validators=[django.core.validators.MaxValueValidator(10)])),
